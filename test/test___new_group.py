# -*- coding: utf-8 -*-
"""
测试目的：验证 torch.distributed.new_group 接口功能正确性
API 名称：torch.distributed.new_group
...
def _worker(rank, ws, dn):
    """Worker: create new subgroup and verify it is not None."""
...
class TestNewGroup(TestCase):
    ...
    def test_2npu(self):
        """Verify new_group creates subgroup across 2 NPU processes."""
